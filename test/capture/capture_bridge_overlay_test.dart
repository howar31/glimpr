...
void main() {
  ...
  test('beginCapture / dismissOverlay / overlayReady invoke the capture channel', () async {
    final calls = <String>[];
  ...
  test('registerOverlayHandlers decodes onCaptureReady and onCaptureFailed', () async {
    ...
    await send('onCaptureFailed', {'reason': 'permissionDenied', 'message': 'x'});
